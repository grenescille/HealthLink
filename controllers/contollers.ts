...
exports.logout = (req: express.Request, res: express.Response) => {
...
//get patient by id
exports.getPatient = async (req: express.Request, res: express.Response) => {
  try {
...
//get doctor by id
exports.getDoctor = async (req: express.Request, res: express.Response) => {
  try {
...
//create a patient
exports.addPatient = async (req: express.Request, res: express.Response) => {
  try {
...
//create a doctor
exports.addDoctor = async (req: express.Request, res: express.Response) => {
  try {
